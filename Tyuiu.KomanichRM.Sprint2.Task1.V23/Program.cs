...
using Tyuiu.KomanichRM.Sprint2.Task1.V23.Lib;

namespace Tyuiu.KomanichRM.Sprint2.Task1.V23
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* False, True, True, True), при a = 242, b = 571, c = 325, d = 155        *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
